define(
    [
        ...
        'Midtrans_Snapio/js/action/set-payment-method',
    ...
    function (Component, $, quote, urlBuilder, storage, errorProcessor, customer, fullScreenLoader, setPaymentMethodAction, additionalValidators, url, messageList) {
        ...
        return Component.extend({
            defaults: {
                template: 'Midtrans_Snapio/payment/snapio'
            },
            ...
            afterPlaceOrder: function () {
                ...
                var enable_redirect = window.checkoutConfig.payment.snapio.enableredirect;
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (enable_redirect === "0") {
                            ...
                            trackResult(data, merchant_id, 'Installment_Offline Snap PopUp', 'pay', null);
                                        ...
                                        snap.pay(data,
                                            {
                                                ...
                                                onSuccess: function (result) {
                                                    trackResult(data, merchant_id, 'Installment_Offline Snap PopUp', 'success', result);
                                                ...
                                                onPending: function (result) {
                                                    trackResult(data, merchant_id, 'Installment_Offline Snap PopUp', 'pending', result);
                                                    messageList.addSuccessMessage({
                                                        message: result.status_message
                                                    });
                                                ...
                                                onError: function (result) {
                                                    trackResult(data, merchant_id, 'Installment_Offline Snap PopUp', 'error', result);
