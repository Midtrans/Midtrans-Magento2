define(
    [
        ...
        'Midtrans_Snapinst/js/action/set-payment-method',
    ...
    function (Component, $, quote, urlBuilder, storage, errorProcessor, customer, fullScreenLoader, setPaymentMethodAction, additionalValidators, url, messageList) {
        ...
        return Component.extend({
            defaults: {
                template: 'Midtrans_Snapinst/payment/snapinst'
            },
            ...
            afterPlaceOrder: function () {
                ...
                var enable_redirect = window.checkoutConfig.payment.snapinst.enableredirect;
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (enable_redirect === "0") {
                            console.log('Pay with snap pop up. with token : ' + data);
                            trackResult(data, merchant_id, 'Installment_Dragon Snap inst PopUp', 'pay', null);
                                        ...
                                        snap.pay(data,
                                            {
                                                ...
                                                onSuccess: function (result) {
                                                    trackResult(data, merchant_id, 'Installment_Dragon Snap inst PopUp', 'success', result);
                                                ...
                                                onPending: function (result) {
                                                    trackResult(data, merchant_id, 'Installment_Dragon Snap inst PopUp', 'pending', result);
                                                    messageList.addSuccessMessage({
                                                        message: result.status_message
                                                    });
                                                ...
                                                onError: function (result) {
                                                    trackResult(data, merchant_id, 'Installment_Dragon Snap inst PopUp', 'error', result);
