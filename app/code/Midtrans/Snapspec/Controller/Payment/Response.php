...
namespace Midtrans\Snapspec\Controller\Payment;
...
class Response extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if (isset($_GET['order_id'])) {
            ...
            $config = $om->get('Magento\Framework\App\Config\ScopeConfigInterface');
            $midtransconf = $om->create('Midtrans\Config');
            $midtransconf::$serverKey = $config->getValue('payment/vtklikbca/server_key_v2', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
            $data = \Midtrans\Transaction::status($_GET['id']);
