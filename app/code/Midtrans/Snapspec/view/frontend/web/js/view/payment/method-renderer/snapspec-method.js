define(
    [
        ...
        'Midtrans_Snapspec/js/action/set-payment-method',
    ...
    function (Component, $, quote, urlBuilder, storage, errorProcessor, customer, fullScreenLoader, setPaymentMethodAction, additionalValidators, url, messageList) {
        ...
        return Component.extend({
            defaults: {
                template: 'Midtrans_Snapspec/payment/snapspec'
            },
            ...
            afterPlaceOrder: function () {
                ...
                var enable_redirect = window.checkoutConfig.payment.snapspec.enableredirect;
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (enable_redirect === "0") {
                            ...
                            trackResult(data, merchant_id, 'Fullpayment Snap Specific PopUp', 'pay', null);
                                        ...
                                        snap.pay(data,
                                            {
                                                ...
                                                onSuccess: function (result) {
                                                    trackResult(data, merchant_id, 'Fullpayment Snap Specific PopUp', 'success', result);
                                                ...
                                                onPending: function (result) {
                                                    trackResult(data, merchant_id, 'Fullpayment Snap Specific PopUp', 'pending', result);
                                                    messageList.addSuccessMessage({
                                                        message: result.status_message
                                                    });
                                                ...
                                                onError: function (result) {
                                                    trackResult(data, merchant_id, 'Fullpayment Snap Specific PopUp', 'error', result);
