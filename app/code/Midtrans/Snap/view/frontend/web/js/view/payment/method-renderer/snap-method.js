define(
    ...
    function (Component, $, quote, urlBuilder, storage, errorProcessor, customer, fullScreenLoader, setPaymentMethodAction, additionalValidators, url, messageList) {
        ...
        return Component.extend({
            defaults: {
                template: 'Midtrans_Snap/payment/snap'
            },
            ...
            afterPlaceOrder: function () {
                ...
                var enable_redirect = window.checkoutConfig.payment.snap.enableredirect;
                                        ...
                                        snap.pay(data,
                                            {
                                                ...
                                                onSuccess: function (result) {
                                                    trackResult(data, merchant_id, 'Fullpayment Snap PopUp', 'success', result);
                                                ...
                                                onPending: function (result) {
                                                    trackResult(data, merchant_id, 'Fullpayment Snap PopUp', 'pending', result);
                                                    messageList.addSuccessMessage({
                                                        message: result.status_message
                                                    });
                                                ...
                                                onError: function (result) {
                                                    trackResult(data, merchant_id, 'Fullpayment Snap PopUp', 'error', result);
