 ...
 * this class is used after placing order, if the payment is Midtrans, this class will be called and link to redirectAction at Midtrans_Snap_PaymentController class
 */
...
class Standard extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    // call to redirectAction function at Midtrans_Snap_PaymentController
