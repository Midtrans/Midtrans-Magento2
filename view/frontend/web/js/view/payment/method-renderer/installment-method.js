define(
    ...
    function (Component, $, quote, urlBuilder, storage, errorProcessor, customer, fullScreenLoader, setPaymentMethodAction, additionalValidators, url, messageList) {
        ...
        return Component.extend({
            defaults: {
                template: 'Midtrans_Snap/payment/installment'
            },
            redirectAfterPlaceOrder: false,
            /** Open VT-Snap */
            afterPlaceOrder: function () {

                var production = window.checkoutConfig.payment.installment.production;
                var client_key = window.checkoutConfig.payment.installment.clientkey;
                var merchant_id = window.checkoutConfig.payment.installment.merchantid;
                var mixpanel_key = window.checkoutConfig.payment.installment.mixpanelkey;
                var magento_version = window.checkoutConfig.payment.installment.magentoversion;
                var plugin_version = window.checkoutConfig.payment.installment.pluginversion;
                var enable_redirect = window.checkoutConfig.payment.installment.enableredirect;
