define(
    ...
    function (Component, $, quote, urlBuilder, storage, errorProcessor, customer, fullScreenLoader, setPaymentMethodAction, additionalValidators, url, messageList) {
        ...
        return Component.extend({
            defaults: {
                template: 'Midtrans_Snap/payment/specific'
            },
            redirectAfterPlaceOrder: false,
            /** Open VT-Snap */
            afterPlaceOrder: function () {

                var production = window.checkoutConfig.payment.specific.production;
                var client_key = window.checkoutConfig.payment.specific.clientkey;
                var merchant_id = window.checkoutConfig.payment.specific.merchantid;
                var mixpanel_key = window.checkoutConfig.payment.specific.mixpanelkey;
                var magento_version = window.checkoutConfig.payment.specific.magentoversion;
                var plugin_version = window.checkoutConfig.payment.specific.pluginversion;
                var enable_redirect = window.checkoutConfig.payment.specific.enableredirect;
